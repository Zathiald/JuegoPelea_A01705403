...
public:
    ...
    */
    Contrincante(float vidaEnem, float fuerzaEnem1,
        float fuerzaEnem2);
    /*Agregamos más parametros para tener sobrecarga
    */
    Contrincante(float vidaEnem, float fuerzaEnem1,
        float fuerzaEnem2,float fuerzaEnem3);

    /*Igual aqui tenemos sobrecarga de funciones
    */
    Contrincante(float vidaEnem, float fuerzaEnem1,
        float fuerzaEnem2, float fuerzaEnem3,float fuerzaEnem4);
    ...
    */ 
    virtual void atacarJugador(string decision, int aJ,
        Jugador* jugador,Contrincante* contrincante)=0;
};
...
*/
Contrincante::Contrincante(float vidaEnem, float fuerzaEnem1,
    float fuerzaEnem2){
    vidaCont = vidaEnem;
